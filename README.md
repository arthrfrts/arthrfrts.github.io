...
Esse sou eu e esse é o meu site.
...
Esse site é feito usando [Jekyll](https://jekyllrb.com/) e hospedado no GitHub Pages usando o [jekyll-actions](https://github.com/marketplace/actions/jekyll-actions) de @helaili.
